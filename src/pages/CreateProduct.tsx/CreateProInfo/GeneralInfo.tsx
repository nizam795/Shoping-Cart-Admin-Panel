...
const GeneralInfo: React.FC<Props> = ({ setSelectedStep }) => {
  const {
    register,
    handleSubmit,
    formState: { errors },
    ...
    <div className=" mt-5">
        ...
        <div className="flex flex-col gap-2 ">
          ...
          <div className="flex gap-3 items-center">
            <label htmlFor="" className="flex gap-1">
              <input type="radio" value="online" {...register("status")} />{" "}
              Online
            </label>
            <label htmlFor="" className="flex gap-1">
              <input type="radio" value="offline" {...register("status")} />{" "}
              Offline
            </label>
            <label htmlFor="" className="flex gap-1">
      ...
      <div className="flex justify-end mt-3">
        ...
        type="button"
          ...
          onClick={() =>handleSubmit(()=>setSelectedStep(1))() }
        >
          Add More Info
        </button>
      </div>
